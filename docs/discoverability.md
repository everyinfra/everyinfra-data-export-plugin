...
- Primary intent: Bounded public-data export to CSV or JSON with an AI agent.
- Supporting terms: csv-export, json-export, data-export, pagination, deduplication, mcp.
