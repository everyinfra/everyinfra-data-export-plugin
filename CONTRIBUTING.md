# Contributing to EveryInfra Data Export
...
Changes to `plugins/everyinfra-data-export/skills/everyinfra-bulk-data-export/SKILL.md` should include updated examples and acceptance criteria when behavior changes. Run `python3 scripts/validate.py` before proposing a patch. Keep all plugin manifest versions aligned and update `CHANGELOG.md` for released behavior changes.
